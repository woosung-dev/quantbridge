...
gate-harnesses:
	@rc=0; for h in bl-audit header-audit soak-restart soak-watch soak-stack docs-audit pre-push-guard assert-main-checkout skip-ratchet signal-check final-gates; do \
	  printf '\n▶ %s-test\n' "$$h"; \
