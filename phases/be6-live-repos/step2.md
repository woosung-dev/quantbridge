...
3. `python3 tools/harness/assert_be.py apps/api/.coverage.harness.json --target src/trading/repositories/live_signal_session_repository.py --min-cov 78 --target src/trading/repositories/live_signal_event_repository.py --min-cov 80 --target src/waitlist/repository.py --min-cov 82`
