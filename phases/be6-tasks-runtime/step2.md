...
3. `python3 tools/harness/assert_be.py apps/api/.coverage.harness.json --target src/tasks/celery_app.py --min-cov 64 --target src/tasks/websocket_task.py --min-cov 76 --target src/tasks/_ws_lease.py --min-cov 90`
