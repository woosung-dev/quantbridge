...
3. `python3 tools/harness/assert_fe.py apps/web/coverage/fe6-api-trading-live --min-cases 22 --target src/features/live-sessions/api.ts --min-cov 45 --target src/features/trading/api.ts --min-cov 45 --target src/features/waitlist/api.ts --min-cov 45 --target src/features/live-sessions/unrealized.ts --min-cov 45`
