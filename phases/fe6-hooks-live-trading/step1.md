# Step 1: 정상 경로 전수 — live-sessions · trading React Query 훅
...
케이스 하한 16 · 대상 커버리지 하한 30% 는 AC 가 잰다.
...
3. `python3 tools/harness/assert_fe.py apps/web/coverage/fe6-hooks-live-trading --min-cases 16 --target src/features/live-sessions/hooks.ts --min-cov 30 --target src/features/trading/hooks.ts --min-cov 30`
