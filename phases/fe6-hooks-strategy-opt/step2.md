# Step 2: 에러·경계 분기 — strategy · optimizer · waitlist React Query 훅
...
3. `python3 tools/harness/assert_fe.py apps/web/coverage/fe6-hooks-strategy-opt --min-cases 22 --target src/features/strategy/hooks.ts --min-cov 45 --target src/features/optimizer/hooks.ts --min-cov 45 --target src/features/waitlist/hooks.ts --min-cov 45`
