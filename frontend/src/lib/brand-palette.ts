...
export const BRAND_PALETTE = {
  // B2 라이트 팔레트 (2026-08-07) — 캐논 5.82 + bull/bear 상호 1.58 을 동시에 만족하는
  // 단일색 안. 근거·트릴레마 = HANDOFF-react-port.md §8.5.
  light: {
    bg: "#f4f5f6",
    bgAlt: "#edeff1",
    card: "#fdfdfc",
    ...
    ddLine: "rgba(173, 50, 42, 0.55)",
    ddTop: "rgba(173, 50, 42, 0.3)",
    ddBottom: "rgba(173, 50, 42, 0.02)",
  },
  dark: {
    bg: "#0b0d0f",
    bgAlt: "#101214",
