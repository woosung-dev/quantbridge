  ...
  return (
    <main className="relative mx-auto flex min-h-[80vh] max-w-md flex-col items-center justify-center overflow-hidden px-6 py-20 text-center">
      ...
      <div
        ...
        className="pointer-events-none absolute left-1/2 top-1/2 z-0 select-none font-display text-[clamp(6rem,15vw,9rem)] font-extrabold leading-[0.9] tracking-tight text-primary-light"
