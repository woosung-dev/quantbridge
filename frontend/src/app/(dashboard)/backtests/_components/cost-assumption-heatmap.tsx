// Sprint 50: Cost Assumption Sensitivity heatmap — fees x slippage 9-cell 시각화 (custom CSS, codex P2#8 접근성 보강)
"use client";
...
interface Props {
  result: CostAssumptionResult;
}

// 색맹 fallback marker (codex P2#8). Sharpe 부호 = 색만이 아닌 ▲/▼ 글리프로 구분.
...
export function CostAssumptionHeatmap({ result }: Props) {
  ...
  return (
    <div className="space-y-3 overflow-x-auto">
      {/* Legend (codex P2#8) — 색만으로 부호를 전달하지 않도록 sign marker 명시 */}
                ...
                return (
                  <td
                    ...
                    className={cn(
                      ...
                      // codex P2#8 — keyboard focus ring (2px outline + offset)
