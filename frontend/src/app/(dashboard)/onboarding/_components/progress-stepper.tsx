// 온보딩 4단계 진행 indicator — Sprint 42-polish W2-fidelity
            ...
            >
              ...
              <div className="relative flex w-full items-center justify-center">
                <div
                  ...
                  className={[
                    "relative z-[2] grid h-8 w-8 shrink-0 place-items-center rounded-full border-2 font-mono text-[0.875rem] font-bold transition-all duration-[250ms]",
                    completed
                ...
                {showLine ? (
                  <div
                    ...
                    className={[
                      "absolute left-1/2 top-1/2 z-[1] h-[2px] w-full -translate-y-1/2",
                      lineCompleted
