...
★**버전의 SSOT 는 레포 루트 [`mise.toml`](../../mise.toml) 하나다** ([ADR-036](../adr/036-tool-version-ssot-mise.md)).
...
**인증 (Better Auth 자체 호스팅 — [ADR-034](../adr/034-auth-self-host-better-auth.md)):**
...
> 상세 획득법은 [`better-auth-setup.md`](../operations/better-auth-setup.md). 모든 변수는 [`env-vars.md`](./env-vars.md) 카탈로그.
...
- 인증 셋업 상세: [`better-auth-setup.md`](../operations/better-auth-setup.md)
