...
> **근거:** 본 문서 §8.1(kickoff preflight) · §8.3(circular oracle 금지) · `docs/development/gates-and-traps.md`. (구 `global.md` §7 은 ADR-026 으로 §8 에 병합.)
...
- 태스크 스펙에 반드시 넣을 것 — G1 수용 기준 · 스택 `AGENTS.md` 의 레이어 규칙(Repository-only · `Decimal` · prefork-safe) · `docs/development/gates-and-traps.md` · **"스펙 밖 리팩토링 금지"**.
