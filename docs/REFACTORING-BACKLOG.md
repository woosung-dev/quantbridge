...
| [BL-226](#bl-226)                                  | FE `isFiniteDecimalString()` regex 가 BE Pydantic Decimal grammar 보다 좁음                                                                       | **P2 (Sprint 52 codex G.4 review 발견, 2026-05-11)**                                 | XS (1h)                | FE 정규식 `^-?\d+(\.\d+)?$` 가 BE Pydantic Decimal 의 `1e-3`, `.5`, `+1` 등 허용 grammar 보다 좁음. 기본 UI 경로 (사용자 직접 입력) 에선 영향 작지만 외부 client / Decimal 직렬화 시 API contract parity 위반. Sprint 53+ 후속 정리 — FE regex 확장 또는 BE strict mode 통일. dogfood 실제 사용 시 UX 영향 작아 P2 deferred.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
