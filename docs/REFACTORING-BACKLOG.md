...
| [BL-203](#bl-203)                                  | trading service.py god file 분할 (5 class → 5 파일: orders/accounts/webhook_secrets/live_sessions/protocols)                                   | **Sprint 48+ deepening 2차 (BL-202 변경 반영 의무)**              | S-M (4-5h)    | /deepen-modules trading audit 발견 (2026-05-09) — service.py 562 LOC 에 5+ 책임 한 파일. Sprint 47 BL-202 registry 변경 반영 의무 (codex G.0 2차 권고). dogfood mixed 시 BL-201/204 와 묶어 cmux 5w 8-12h. ★★★★☆. Risk 🟡 (단순 파일 분할, import path mass migration)                                                                                                                                                                                                |
| [BL-204](#bl-204)                                  | trading repository.py god file 분할 (3 class → 4 파일: orders/exchange_accounts/kill_switch_events/webhook_secrets)                            | **Sprint 48+ deepening 2차 (BL-203 묶음)**                        | S (2-3h)      | /deepen-modules trading audit 발견 (2026-05-09) — repository.py 714 LOC 에 3 class 한 파일. test 는 이미 4 파일 분리. Sprint 48+ BL-203 와 묶어서 ROI ↑. ★★★☆☆. Risk 🟢                                                                                                                                                                                                                                                                                               |
