...
| [BL-150](#bl-150)                               | Equity chart full migration recharts → lightweight-charts (점진 마이그레이션 완료)          | Sprint 31+ (β 점진적 후속)                   | M (3-4h)      | Sprint 30-β Option B ADR `2026-05-05-sprint30-chart-lib-decision.md` |
...
- **2026-05-05 (Sprint 34 종료 — 3 PR all merged + mid-dogfood Day 6.5 PASS)** — `main @ 27ff836`. dogfood Day 7 = **TBD (사용자 입력 대기)**. Sprint 35 분기 = Day 7 결과 따라 결정 (≥7 → Beta 본격 진입 BL-070~072 / <7 → polish iter 3 BL-178 + BL-179 + BL-176 follow-up + BL-174 detail + BL-177-A/B/C).
