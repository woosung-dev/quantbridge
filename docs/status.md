...
> **Last Updated:** 2026-07-28 (**live-observability** — worker metric 배선 + 1h40m 실주행 판정표)
> **Active Sprint:** **live-observability** — 10스프린트 동안 쌓은 안전장치가 작동하는지 **볼 방법이 없던 것**을 배선하고 실제로 읽는다
> **Active Branch:** `feat/live-observability`
