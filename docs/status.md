...
**다음 행동 = 개발 항목을 ⓪ 표에서 고른다** — 표 3행 중 A행([BL-650])은 「도래 아님」 표기이고, 진짜 후보는 B([BL-453])·AP([BL-774]) 둘이다. ★함께 정할 것 = `ledger-vitals` ② 의 **≥3행** 근거(위에 적은 대로 세 번째 후보가 실재하지 않는다).
...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | ----------------------------------------------------------------------------------------------------------------- | ------ | --------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A**  | [BL-650] `.next` 빌드 캐시 정책 — 재야 할 축은 `.next/dev/cache` 다(빌드가 아니라 dev 서버가 키운다) | P2  | ★ | 하     | S | **미착수**     | ★**2026-08-25 n11 preflight — 재채취로는 측정점이 안 는다.** `du -sm apps/web/.next`=1,711MB 가 3번째 값과 같았고 원인은 `.next` mtime 이 **2026-08-22** 라는 것(그 사이 메인이 FE 를 안 빌드했다). ⇒ 다음 채취는 **메인 FE 빌드 직후**여야 한다. ★단 닫는 조건(「몇 GB에서 태우기 시작하나」 정책)은 **사용자 결정**이고, 이 행이 A 로 올라온 것은 [BL-520] 종결 뒤 `ledger-vitals` ② 가 3행을 요구했기 때문이다 — **도래한 후보가 아니다** |
