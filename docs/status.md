...
| **L** | [BL-703] PARTIAL 24건이 트리거 판정 줄을 안 가져 「PARTIAL ∧ 도래」가 구조적 공집합이다                        | P1  | ★★★★ | 중     | M          | 0줄                            | ★**2026-08-11 등재 — [BL-702] 술어의 한쪽 입력이 비어 있다.** 실측: ACTIVE 6/6 · DEFERRED 155/155 · **PARTIAL 0/24**(양성 대조가 이 0 을 사실로 만든다). 그 안에 **P0 1 + P1 4**([BL-003]·[BL-438]·[BL-619]·[BL-641]·[BL-661])가 있고 **한 건도 ⓪ 표에 안 올라온다.** ★기계 판정을 그대로 채택하지 마라 — 초판이 5건을 근거 없이 도래로 올렸다                                                                                                                                                                                     |
