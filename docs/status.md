...
| ④   | **양성 대조** — `qb_live_conditional_fill_ownership_total{outcome=engine_only_suppressed\|ledger_only_adopted}` | **≥ 5건**  | —             | 수리가 발화한 증거 |
...
라벨을 조용히 무해 취급 · **[BL-591]** D1(strike TTL 부재)/D2.
