...
**다음 행동 = PR #855 · #856 · #857 을 순서대로 머지한다** — 셋 다 CI 판정을 받았거나 받는 중이고,
머지 뒤 남는 것은 원장의 **P1 2건**(**[BL-837]** WS supervisor 침묵 · **[BL-838]** worker 경보 무음)이다.
★그 둘은 **[BL-838] 을 먼저 해라** — 한 줄이고, 그것이 살아나야 [BL-837] 이 났을 때 사람이 알 수 있다.
