...
★이제 순서가 성립한다. [BL-838] 이 먼저였던 이유가 **경보가 살아나야 [BL-837] 이 실제로 발생했을 때
사람이 알 수 있다**였고, 그 전제가 이번에 충족됐다.
★Risk 🟠 — 라이브 신호 경로라 수리 자체가 소크 리스크다. 선례 = `track_pending_alert` 가 alert task 에
대해 이미 하는 것. 회귀 자리 = `tests/tasks/test_first_connect_race.py` 인접.
...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | ----------------------------------------------------------------------------------------------------------------- | ------ | --------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **I**  | [BL-837] WS supervisor 가 예상 밖 예외로 죽으면 stream 이 **lease 를 쥔 채** 영구 침묵 | P1 | ★★★ | 중 | M | **건드림** | **2026-08-30 등재** — `bybit_private_stream.py:313` 의 `create_task` 에 `add_done_callback` 이 없어 다음 관측 시점이 **종료 때**다. 그 사이 `websocket_task.py:144` 의 lease 가 계속 갱신돼 **failover 도 막힌다**. 선례 = `track_pending_alert`. ★Risk 🟠 라이브 신호 경로 |
