...
**다음 행동 = ⓪ 표를 정리한다 — RESOLVED 5건(BL-634·701·773·808·810)이 살아 있는 행으로 남아
있고, 3회차 실사가 반증한 원장 3건([BL-661] 잔여는 [BL-669] 로 이관 완료 · [BL-671] 잔여 1건은
「값 0」 근거가 원장 자신에 있음 · [BL-639] 실패 모드 3은 `account_exclusivity.py:31-46`
docstring 이 이미 결정·구현했다고 명시)도 함께 정정한다.**
