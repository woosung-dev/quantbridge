...
> 의존: [`system-architecture.md`](../../architecture/system-architecture.md), [`docker-compose-guide.md`](../docker-compose-guide.md)
...
- ADR-001 기술 스택: [`ADR-001`](../../../decisions/001-tech-stack.md)
- Compose: [`docker-compose-guide.md`](../docker-compose-guide.md)
