...
> **역할 구분:**
>
> - 환경 셋업 + 리스크 대응은 [`h1-testnet-dogfood-guide.md`](../infrastructure/h1-testnet-dogfood-guide.md) 이 SSOT.
...
| CI 가 잡는 regression 기준 | `reference/architecture/trust-layer-architecture.md` §3                |
| SLO 상세                   | `reference/product/trust-layer-requirements.md` §3                      |
