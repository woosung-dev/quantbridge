...
> **SSOT (2026-05-04 cleanup):** 본 문서가 **Trust Layer 요구사항/SLO 의 단일 진실 원천**. 아키텍처: [`trust-layer-architecture.md`](../architecture/trust-layer-architecture.md) (3-Layer Parity 설계), ADR: [`ADR-020`](../../decisions/020-trust-layer-ci-design.md) (결정 근거).
>
> **상태:** Path β Stage 0 초안 (2026-04-23). Stage 2 구현 + Gate-2 통과 시 **확정**.
> **상위 문서:** [`trust-layer-architecture.md`](../architecture/trust-layer-architecture.md), [`ADR-020`](../../decisions/020-trust-layer-ci-design.md), [`ADR-016`](../../decisions/016-sprint-y1-coverage-analyzer.md)
> **관련 Sprint:** Path β · 관련 PR: Stage 2 에서 작성 예정
> **상호 참조:** [`trading-demo-baseline.md`](./trading-demo-baseline.md) (dogfood 체결 baseline), [`pine-coverage-assignment.md`](../domain/pine-coverage-assignment.md) (coverage SSOT)
...
1. Mutation 측정 실패 layer / 케이스 식별 → `docs/reference/product/trust-layer-requirements.md` §4.2 표에 1 row 추가 (SLO + 실패 사유 + scope-reducing 결정).
...
**Related:** ADR-020 (CLAUDE.md), [B5-ADR](../architecture/architecture-conformance.md#b5-adr), [BL-057](../../backlog.md#bl-057)
