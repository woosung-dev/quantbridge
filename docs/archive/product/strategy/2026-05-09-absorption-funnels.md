...
> **상위:** [`positioning.md`](strategy/positioning.md) (한 줄 카피), [`competitive-landscape.md`](strategy/competitive-landscape.md) (5+1 비교)
...
- `docs/reference/operations/workflows/migrate-from-freqtrade.md` — 1:1 매핑 표 + Pine Script 변환 예제 3개
...
- `docs/reference/operations/workflows/migrate-from-jesse.md` — 전략 어휘 매핑 (jesse Strategy class → Pine indicator/strategy)
...
- `docs/reference/operations/workflows/why-not-transpile.md` — transpile vs interpret 본질 차이 (DrFX 650줄 + Phase -1 4 모델 변환 버그 evidence)
