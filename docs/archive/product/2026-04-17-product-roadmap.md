...
> **SSOT (2026-05-04 cleanup):** 본 문서가 **Horizon × Pillar 로드맵의 단일 진실 원천**. 관련 ADR: [`ADR-010b`](../../../decisions/010b-product-roadmap.md) (재작성본, 활성). 1차 초안은 현 저장소에 보존본이 없다.
> **PRD ↔ 본 로드맵 ↔ Phase 매핑:** Phase 정의 = [`phase-vs-sprint-mapping.md`](./phase-vs-sprint-mapping.md), 도메인 진행도 = [`domain-progress-matrix.md`](../domain-progress-matrix.md) (둘 다 생성 완료).
>
...
> **H2 Kickoff plan:** [`2026-04-20-h2-kickoff.md`](../../../archive/superpowers/plans/2026-04-20-h2-kickoff.md) — 6 결정 포인트 + Sprint 9~11 분해 + Beta 5~10명 획득 경로
...
| Pillar                   | 의미                                                                                                                                                                                                                                                                                                                                                                                                                                     | 우선순위                        |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| 🛡 **Trust (신뢰)**      | 본인이 실자본 맡겨도 안심되는 품질. **4 sub-pillar:** ① **Backend Reliability** (실거래 안정성, Pine Trust Layer, WS 무결, prefork-safe Celery, 24h+ Auto-Loop), ② **Risk Management** (Kill Switch, leverage cap, capital_base 동적, 청산 시뮬레이션), ③ **Security** (BYOK + AES-256 MultiFernet, Clerk JWT, secrets manager), ④ **Surface Trust** (가정 박스 / 차트 인터랙션 / 24 metric depth / 거래 목록 — Sprint 30 ADR-019 신설). | **최우선** — H1에 집중          |
...
**Surface Trust sub-pillar 측정 기준 (Sprint 30 ADR-019):** PRD `backtests.results` 24 metric BE+FE 100% / `backtests.config` 5 가정 FE 노출 100% / lightweight-charts PRD §Phase 1 주 4 부분 마이그레이션 / dogfood self-assess Day 3 ≥ 7. 상세 [`2026-05-05-sprint30-surface-trust-pillar-adr.md`](../../../dev-log/2026-05-05-sprint30-surface-trust-pillar-adr.md).
...
- **Sprint 추적**: [`status.md`](../../../status.md) — Completed / Next Actions / Blocked / Questions
- **프레임·철학 근거**: [`ADR-010b`](../../../decisions/010b-product-roadmap.md)
- **Sprint 7c scope (H1)**: [`ADR-008`](../../../decisions/008-sprint7c-scope-decision.md)
- **요구사항 상세**: [`requirements-overview.md`](../requirements-overview.md)
- **배포 플랜**: [`deployment-plan.md`](../../operations/infrastructure/deployment-plan.md)
- **관측성 플랜**: [`observability-plan.md`](../../operations/infrastructure/observability-plan.md)
