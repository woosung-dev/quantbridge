...
| ---------- | ------------------------------------------- | ------------------------------ | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-04-17 | `2026-04-17-pine-execution-v4-design.md`    | Pine v4 execution              | `plans/2026-04-19-sprint-8c-user-function-3track.md` | [ADR-003](../../../decisions/003-pine-runtime-safety-and-parser-scope.md), [ADR (dev-log/011)](../../../decisions/011-pine-execution-strategy-v4.md) |
...
| 2026-04-15 | `2026-04-15-pine-parser-mvp-design.md`      | Pine parser MVP                | `plans/2026-04-15-pine-parser-mvp.md`                | [ADR-003](../../../decisions/003-pine-runtime-safety-and-parser-scope.md), [ADR-004](../../../decisions/004-pine-parser-approach-selection.md)       |
...
| 주제             | SSOT                                                                                                     | Deprecated                                                                                           |
| ---------------- | -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Pine 실행 전략   | [`04_architecture/pine-execution-architecture.md`](../../../reference/pine-execution-architecture.md) | `dev-log/011-pine-execution-strategy-v4.md` + `2026-04-17-pine-execution-v4-design.md` (본 디렉토리) |
