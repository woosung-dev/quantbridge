...
- [x] **최종 codex 누적 diff 리뷰 1회** (`main...HEAD`) — **REVISE [P2] 1건**(세션 읽기↔주문 조회 TOCTOU). 전건 코드 대조 후 **회귀 아님**으로 판정(변경 전에는 창이 아예 없어 항상 전 기간 포함 · 읽기 전용 · 자가 교정) → 수정 대신 [BL-459](../../../backlog.md#bl-459) 등재 + 계약 §3.3 명시
