...
| P0   | `docs/architecture/pine-execution-architecture.md:16-27,45`   | 실행 경로 mermaid 에 **`run_live` 가 아예 없다**            |
| P0   | `docs/architecture/trust-layer-architecture.md:9-14,33-38`    | 3층 표에 live parity 항목 없음                              |
| P1   | `docs/adr/020-trust-layer-ci-design.md:33,39`                 | P-3 정의가 `BacktestOutcome.metrics` 기준                   |
| P1   | `docs/domain/domain-overview.md:25,43`                        | 「Pine 실행은 pine_v2 가 맡는다」                           |
| P2   | `docs/domain/requirements-overview.md:24,28` · `README.md:15` | 방어 범위 한정 명시                                         |
