...
★**현재 최대 리스크는 [BL-536] + [BL-522] 다** (2026-08-01 silent-surface-honesty 에서 지정. 앞선
「슬롯이 비어 있다」를 대체한다). 열린 P1 8건 중 실자금 축은 이 둘뿐이고 나머지 6건(BL-015/022/023/
024/025/026)은 테스트·인프라 부채다. **[BL-522] Trigger 가 「실자금 cutover 전 필수」라고 못박고 있다.**

★★**단 첫 step 은 「수정」이 아니라 「재판정」이다 — 두 항목의 크기 근거가 모두 이미 반증된 값 위에 서 있다.**
...
- **[BL-536]** 의 현행 판정 **「유지」**(`backlog.md:4351`)는 **두 근거가 모두 C2 에 의존한다** —
...
BL-522 본문의 「시간당 14회」를 정정하는 것.** 그 전에는 이 둘의 크기를 인용하지 마라.
