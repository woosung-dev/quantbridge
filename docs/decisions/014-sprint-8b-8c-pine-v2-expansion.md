...
> **상위 문서:** [`pine-execution-architecture.md`](../reference/architecture/pine-execution-architecture.md)
...
- `architecture/pine-execution-architecture.md` 에 3-Track dispatcher 섹션 추가 필요 (Path β S0-C3 에서 처리)
