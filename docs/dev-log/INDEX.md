...
- **2026-08-10 bl-trigger-triage + precommit-scope** — 어휘 `DEFERRED` 신설 · ACTIVE 159 → 7 · [BL-687]·[BL-695] 종결. ★★★**판정기 초판이 5건을 근거 없이 「도래」로 올렸고 잡은 것은 전량 스윕이 아니라 그 앞의 음성 대조였다** — dev-log
- **2026-08-11 bl-703-partial-verdicts** — [BL-703] 종결. PARTIAL **0/24 → 24/24** 판정(도래 5) · `docs-audit`·sweep 이 PARTIAL 포함 · ⓪ 표 9→13행. ★★★**착수 근거가 반증** — 「P0 1 + P1 4 가 올라온다」 중 셋이 미도래고, 대신 원장이 몰랐던 [BL-639]·[BL-672] 가 올라왔다 — dev-log
