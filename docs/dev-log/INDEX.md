...
- **2026-08-15 surface-truth** — 보안 P1 5건(S1~S5) + 여정 8건 + BL-753~759. ★★★**`/openapi.json`·`/docs` 가 인터넷에 200** — 배포 호스트가 `APP_ENV` 를 안 넣어 게이트 4개가 꺼져 있었다. ★API secret 이 **422 body 에 반사** · 탈퇴가 **돈을 안 멈춤** · Redis LRU 가 큐·락 축출. ★★[LESSON-113]
