...
- **2026-08-07 gap-resync-autopsy** — ★[BL-618] 사망 부검 **H3 확정**: 거래소 체결 `20:17:19.519` vs 우리 관측 `20:31:51.622`(**872초** 지연), 판정은 그 3.5초 전. 같은 세션 다른 3건은 **50ms** ⇒ 계통 아님. 수리 = claim **앞**에서 유예(변이 4/4 적발). [BL-603] 비용 0.300%→0.138% — `s3_rsid` 손익 **부호 반전**. LESSON-075/076
