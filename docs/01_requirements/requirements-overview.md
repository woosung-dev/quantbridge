...
| **Phase 1.5b (신규, Sprint 28 office-hours Addendum)** | **~12주**    | **Live Trading 조기 구현 (Multi-account/symbol/timeframe + Auto-Loop 자동화 + Auth Trust Layer + WebSocket Stability)** — dogfood-first 우선 | **🔄 Sprint 6~28 진행 (Slice 1a/1b/2/3/4 = Beta prereq 마무리)** |
| Phase 2                                                | 4주          | 스트레스 테스트 (Monte Carlo, Walk-Forward) + 파라미터 최적화                                                                                | ⏳ H2 Sprint 29+ (Beta 후)                                       |
...
| Stress Test                                                       | REQ-ST-\* (Monte Carlo, Walk-Forward)                                                                        | H2 Sprint 29+ (Beta 후)                           |
| Optimizer                                                         | REQ-OPT-\* (Grid, Bayesian)                                                                                  | H2/H3 Sprint 후속                                 |
| Trading                                                           | REQ-TRD-\* (데모/라이브, Risk Mgmt, Kill Switch)                                                             | Sprint 6-28 ✅ Phase 1.5b                         |
| Exchange                                                          | REQ-EX-\* (계정 관리, API Key 암호화)                                                                        | Sprint 6-7 ✅                                     |
| **WebSocket Stability (신규, Sprint 28)**                         | **REQ-WS-\*** (reconnect / orphan buffer / lease / partial fill 등 BL-001/011-016)                           | Sprint 12-19 ✅ partial                           |
| **Auth Trust Layer (신규, Sprint 28)**                            | **REQ-AUTH-TRUST-\*** (15 ADR + commit-spy LESSON-019 + outer commit broken bug 방어)                        | Sprint 13-15 ✅                                   |
| **Multi-account/symbol/timeframe Live Trading (신규, Sprint 28)** | **REQ-TRD-MULTI-\*** (PR #100 Sprint 26, Bybit Demo + OKX 어댑터 동시 + BTC/SOL + 1m/5m/15m/1h)              | Sprint 26 ✅                                      |
| **Auto-Loop dogfood 자동화 (신규, Sprint 28)**                    | **REQ-OPS-\*** (Beat scheduler + Worker dispatch + reconcile_ws_streams + 26h+ 무중단 dispatch rate 1.0/min) | Sprint 27 ✅                                      |
