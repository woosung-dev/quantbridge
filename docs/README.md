...
| [design-docs-map.md](./design-docs-map.md)         | **디자인 문서 지도 — 어느 문서가 정본인지 판정. 디자인 작업 전 필독** | ⭐ 정본  |
| [DESIGN.md](../DESIGN.md)                          | 디자인 시스템 (색상, 타이포, 컴포넌트) — **1세대, 현재 앱이 따름**    | ✅ 현행  |
| [prototypes/](./prototypes/)                       | 구세대 Stage 2 12벌(superseded) + **C 디자인 언어 17벌**(목표 캐논)   | 혼재     |
| [c-language-port/](./c-language-port/)             | C 디자인 언어 React 이식 진행 정본 (HANDOFF · 슬라이스 S0~S9)         | 진행 중  |
