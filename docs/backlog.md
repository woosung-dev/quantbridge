...
| ID                | 제목                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Trigger                                                                                                         | Est          | 출처                                                         |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------ |
| [BL-746](#bl-746) | ✅ **감시 타이머 위상 고정 — Resolved (2026-08-15 soak-watch-restore 후속)**. `OnUnitActiveSec` 은 **마지막 활성화 기준**이라 사람이 손으로 한 번 돌리면 위상이 밀린다 — 최악 `29+30=59`분이고 C4 한계가 60분인데 systemd 기본 `AccuracySec` 이 1분이라 여유가 사실상 0. 실측 **53분**. ★**이 회차의 검증 자신이 만든 위험**이었다. `OnCalendar=*:00/30`+`AccuracySec=30s` 로 벽시계 고정 — 강제 발화 전후 `NEXT` 불변 실증                                                                                                                                                                                                                                                                                                                                                                            | 도래 — 53분 간격 실측                                                                                           | XS (20분)    | 2026-08-15 soak-watch-restore                                |
