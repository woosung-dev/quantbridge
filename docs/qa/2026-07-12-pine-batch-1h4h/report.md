...
| ② bs 4h 2024    | ta.ema(SMA 시드) + EMA(5/13) 크로스 + 양봉 확인              | 엔진 시멘틱(nan→False) 수계산 **bar 12 long — 완전 일치**. 단 TV na-전파 시멘틱으로는 첫 시그널이 bar 15 short — **워밍업 경계 스퓨리어스 시그널 1건 발견 → BL-405** |
