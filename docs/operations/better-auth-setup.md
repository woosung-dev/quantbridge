...
> [ADR-034](../adr/034-auth-self-host-better-auth.md).
> **SSOT:** 라이브러리 문서는 https://www.better-auth.com/docs · 본 문서는 QuantBridge 통합 관점.
> **환경 변수 카탈로그:** [`env-vars.md`](../development/env-vars.md) §3
>
...
- 결정 근거: [ADR-034](../adr/034-auth-self-host-better-auth.md)
- FE 배포: [`frontend-deploy.md`](./frontend-deploy.md) · 환경 변수: [`env-vars.md`](../development/env-vars.md)
