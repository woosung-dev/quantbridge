...
> **결과 기록 위치**: `docs/archive/dogfood/sprint42-feedback.md` 의 `Friend 1` / `Friend 2` 섹션 + `Day 7 mid-check row`.
...
- `docs/archive/dogfood/sprint42-feedback.md` — 결과 기록 위치
...
- `docs/dev-log/2026-05-13-sprint59-close.md` — Sprint 59 결과 + Sprint 60 prereq 명시
