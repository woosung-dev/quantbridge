...
- ADR-011 Phase -1 amendment **진행 중** (2026-04-18~, 브랜치 `docs/adr-011-phase-1-amendment`) — §9 신뢰도 8→9, §12 blocker 2개 해소, §4 Tier-2 KPI 기준점 재정의, §6 H1 MVP scope 축소, §13 실측 부록 신규
- **다음:** Sprint 8a Tier-0 pynescript 포크 착수 (브랜치 `feat/sprint8a-tier0-pynescript-fork`). H1 MVP scope: TP/SL/LONG/SHORT만 (trail_points/qty_percent/pyramiding H2+ 이연). Sprint 7d(OKX + Trading Sessions)는 Sprint 8a/8b 종료 후 H1 내 편성
