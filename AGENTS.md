...
**활성 브랜치:** `main @ dcd30f4` (Sprint 36 BL-150/BL-176 Resolved)

**활성 sprint:** Sprint 37 — **polish iter 5 (Day 7 재측정 목표)**. Sprint 36 Day 7 self-assess = **≤6/10 → gate (a) FAIL** → Sprint 37 = BL-183 fix + 사용자 피드백 BL + Day 7 재측정.

**Sprint 37 진행 현황:**

- **BL-183** (MC 요약 통계 FE 미노출 — CI 95%/median/MDD p95 테이블) = P1 우선순위, Day 7 점수 직접 영향
- 사용자 추가 피드백 기반 BL = office-hours 결정 예정
- BL-181 (Docker worker auto-rebuild) = P2 stretch
...
**미해결 BL:** [`docs/REFACTORING-BACKLOG.md`](docs/REFACTORING-BACKLOG.md) — Sprint 36 BL-150 / BL-176 Resolved + BL-183 신규 등록. 총 **86 active BL**
