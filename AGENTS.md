...
- Sprint 8a-pre Phase -1 실측 **진행 중** (2026-04-18~, 브랜치 `experiment/phase-minus-1-drfx`) — N-way 비교 매트릭스(5 Pine 스크립트 × 최대 7 엔진 × 8 지표). PyneCore 오라클 + QB 파서 baseline + LLM 4개 모델(Opus/Sonnet/GPT-5/Gemini). 상세: [`docs/superpowers/plans/2026-04-18-phase-minus-1-measurement-plan.md`](docs/superpowers/plans/2026-04-18-phase-minus-1-measurement-plan.md)
- **다음:** Sprint 8a-pre Day 1-3 실측 리포트 → ADR-011 amendment(필요 시) → Sprint 8a Tier-0 코어. Sprint 7d(OKX + Trading Sessions)는 Sprint 8a-pre/8a 종료 후 H1 내 편성
