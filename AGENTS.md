...
**활성 브랜치:** `stage/h2-sprint26-signal` (Sprint 25 main `aed201f` PR #96 머지 후 새 cascade)

**최근 완료:** H2 Sprint 25 — Hybrid (FE E2E Playwright + BE 강화 + codex G.0/G.2)
...
- 사용자 협조 1 step pending: `frontend/.env.local` Clerk 4 키 채워진 후 `pnpm e2e:authed` 실 검증

**다음 분기:** [`~/.claude/plans/h2-sprint-26-prompt.md`](~/.claude/plans/h2-sprint-26-prompt.md) (Path A Beta 오픈 / Path B G.2 P2 hardening / Path C BL-110b)
