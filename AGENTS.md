...
**활성 브랜치:** `main @ 8df5e58` (PR #156 Sprint 35 retro merge)

**활성 sprint:** Sprint 36 — **polish iter 4 (Day 7 재측정 목표)**. Sprint 35 Day 7 self-assess = **6/10 → gate (a) FAIL** → Sprint 36 = 새 발견 BL fix + Day 7 재측정.

**Sprint 36 진행 현황:**

- **PR #157** (`feat/sprint36-bl150-bl176`, **merged** 2026-05-06): BL-150 MC bootstrap sign-flip 버그 fix + BL-176 SelectWithDisplayName onClear prop. BE +3 / FE +3 신규 GREEN.
- **BL-150 ✅ Resolved**: Walk-Forward (20/38 folds) + Monte Carlo fan chart 정상 렌더 E2E 확인. MC 음수 equity return sign-flip 차단 (`eq_base=abs` + `clip(-0.9999, None)`).
- **BL-176 ✅ Resolved**: onClear prop 구현 (5/5 unit test GREEN). sentinel/nullable 없이 schema required 유지.
- **P2 stretch**: BL-181 (Docker worker auto-rebuild trigger) = Sprint 36 미착수.
- **defer Sprint 36+ confirmed**: BL-174 detail / BL-177-A/B/C / BL-179 / vectorbt native
...
**미해결 BL:** [`docs/REFACTORING-BACKLOG.md`](docs/REFACTORING-BACKLOG.md) — Sprint 36 BL-150 / BL-176 Resolved (PR #157 merged). 총 **85 active BL**
