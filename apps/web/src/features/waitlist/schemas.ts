...
export const ExchangeCapitalSchema = z.enum(["under_1k", "1k_to_10k", "10k_to_100k", "over_100k"]);
export type ExchangeCapital = z.infer<typeof ExchangeCapitalSchema>;

export const PineExperienceSchema = z.enum(["none", "beginner", "intermediate", "expert"]);
export type PineExperience = z.infer<typeof PineExperienceSchema>;

export const WaitlistStatusSchema = z.enum(["pending", "invited", "joined", "rejected"]);
...
export const CreateWaitlistApplicationSchema = z.object({
  email: z.string().min(3).max(320).regex(emailPattern, "Enter a valid email address"),
...
export type CreateWaitlistApplication = z.infer<typeof CreateWaitlistApplicationSchema>;
...
export type InviteTokenVerifyResponse = z.infer<typeof InviteTokenVerifyResponseSchema>;
...
export type WaitlistApplicationResponse = z.infer<typeof WaitlistApplicationResponseSchema>;
