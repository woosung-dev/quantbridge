...
// Admin waitlist 대시보드 본문 (client) — KPI strip + filter bar + sortable table. page.tsx(server) 가 렌더.
...
import { WaitlistFilterBar, type WaitlistFilter } from "./waitlist-filter-bar";
