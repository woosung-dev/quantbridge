...
export const backtestKeys = {
  ...
  detail: (userId: string, id: string) => [...backtestKeys.details(userId), id] as const,
  progress: (userId: string, id: string) => [...backtestKeys.all(userId), "progress", id] as const,
...
export const stressTestKeys = {
  ...
  detail: (userId: string, id: string) => [...stressTestKeys.details(userId), id] as const,
