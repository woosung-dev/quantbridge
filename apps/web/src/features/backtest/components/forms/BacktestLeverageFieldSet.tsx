    ...
    >
      ...
      {hasMarginModel ? (
        ...
        >
          ...
          <p>
            TradingView 는 마진콜 시 포지션 일부만 청산하지만, 이 백테스트는 Bybit 격리마진처럼{" "}
            <strong>전량 청산</strong>합니다.
          </p>
          <p>
            증거금 충분 여부는 수수료·슬리피지를 차감한 자본으로 판정합니다. 단 주문 수량 계산 (자본
            대비 %)은 여전히 차감 전 자본을 기준으로 합니다.
          </p>
