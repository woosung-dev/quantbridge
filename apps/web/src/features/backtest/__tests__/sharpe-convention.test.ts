...
import { describeSharpe, SHARPE_CONVENTION } from "@/features/backtest/sharpe-convention";
import { EMPTY_CELL } from "@/lib/labels";

describe("describeSharpe", () => {
  it.each([
    [SHARPE_CONVENTION.monthly, 1.234, "1.23", "무위험 2%/년 · 월간 수익률 기준", false, false],
    [
    ...
    [null, 1.234, "1.23", "구 기준(봉 수익률 · 무위험 0%) - 현재 기준과 비교 불가", true, false],
  ])(
    "%s 기준을 표시 계약으로 변환한다",
    (convention, value, display, foot, isLegacy, isUnavailable) => {
