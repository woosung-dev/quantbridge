...
export const OptimizationRunResponseSchema = z.object({
  ...
  user_id: z.uuid(),
  backtest_id: z.uuid(),
  strategy_id: z.uuid().nullable().optional(),
  backtest_symbol: z.string().nullable().optional(),
  backtest_timeframe: z.string().nullable().optional(),
  backtest_period_start: z.iso.datetime({ offset: true }).nullable().optional(),
  backtest_period_end: z.iso.datetime({ offset: true }).nullable().optional(),
  kind: OptimizationKindSchema,
