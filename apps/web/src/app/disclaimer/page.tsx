  ...
  return (
    ...
    >
      <LegalCallout label="[Beta 단계 — 사용자와 함께 다듬는 중입니다]">
        본 문서는 H2 Beta 단계의 임시 템플릿입니다. H2 말 (~2026-06-30) 한국 변호사 검토본으로 교체
        예정.
      </LegalCallout>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          <strong> 투자 자문 (investment advice) 이 아닙니다</strong>. 사용자는 본인 책임 하에 거래
          결정을 내려야 하며, 필요 시 자격 있는 금융 자문가와 상의해야 합니다.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <LegalCallout label="중요 경고:">
          ...
          레버리지 거래 시 손실은 투입 자본을 초과할 수 있습니다. 과거 백테스트 성과는 미래 성과를
          보장하지 않으며, 시장 상황·거래소 정책·네트워크 장애 등 다양한 요인으로 인해 실제 결과가
          백테스트와 상이할 수 있습니다.
        </LegalCallout>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          QuantBridge 운영자는 서비스 사용으로 인한 직접·간접·우발적·특별·결과적 손해에 대해 법이
          허용하는 최대 한도 내에서 <strong>어떠한 책임도 지지 않습니다</strong>. 이는 데이터 손실,
          거래 손실, 영업 기회 상실, 기술적 장애를 포함하되 이에 한정되지 않습니다.
        </p>
      </section>
